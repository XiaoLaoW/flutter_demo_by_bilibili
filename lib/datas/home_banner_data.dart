...
class HomeBannerData {
  ...
  HomeBannerData.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(BannerItemData.fromJson(v));
      });
    }
    _errorCode = json['errorCode'];
    _errorMsg = json['errorMsg'];
  }
  List<BannerItemData>? _data;
  num? _errorCode;
  String? _errorMsg;
HomeBannerData copyWith({  List<BannerItemData>? data,
  num? errorCode,
  String? errorMsg,
  ...
  List<BannerItemData>? get data => _data;
...
class BannerItemData {
  ...
  num? _type;
  String? _url;
BannerItemData copyWith({  String? desc,
  num? id,
  String? imagePath,
  num? isVisible,
  num? order,
  ...
  num? type,
  String? url,
}) => BannerItemData(  desc: desc ?? _desc,
  id: id ?? _id,
