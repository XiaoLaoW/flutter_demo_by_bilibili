...
class KnowledgeListData {
  ...
  KnowledgeListData.fromJson(dynamic dataList) {
    if (dataList is List) {
      for (var v in dataList) {
        list?.add(KnowledgeData.fromJson(v));
      }
    }
  }
}
...
class KnowledgeData {
  KnowledgeData({
      ...
      String? author, 
      List<KnowledgeDataChildren>? children,
      num? courseId, 
      String? cover, 
      String? desc, 
      num? id, 
  ...
  KnowledgeData.fromJson(dynamic json) {
    ...
    if (json['children'] != null) {
      ...
      json['children'].forEach((v) {
        _children?.add(KnowledgeDataChildren.fromJson(v));
      });
    }
  ...
  String? _author;
  List<KnowledgeDataChildren>? _children;
  num? _courseId;
  String? _cover;
  String? _desc;
  num? _id;
  ...
  num? _visible;
KnowledgeData copyWith({  List<dynamic>? articleList,
  String? author,
  List<KnowledgeDataChildren>? children,
  num? courseId,
  String? cover,
  ...
  bool? userControlSetTop,
  num? visible,
}) => KnowledgeData(  articleList: articleList ?? _articleList,
  ...
  List<KnowledgeDataChildren>? get children => _children;
...
class KnowledgeDataChildren {
  KnowledgeDataChildren({
      List<dynamic>? articleList, 
      String? author, 
  ...
  KnowledgeDataChildren.fromJson(dynamic json) {
    if (json['articleList'] != null) {
      _articleList = [];
      json['articleList'].forEach((v) {
        _articleList?.add(v);
  ...
  bool? _userControlSetTop;
  num? _visible;
KnowledgeDataChildren copyWith({  List<dynamic>? articleList,
  String? author,
  List<dynamic>? children,
  num? courseId,
  String? cover,
  ...
  bool? userControlSetTop,
  num? visible,
}) => KnowledgeDataChildren(  articleList: articleList ?? _articleList,
  author: author ?? _author,
  children: children ?? _children,
  courseId: courseId ?? _courseId,
  cover: cover ?? _cover,
